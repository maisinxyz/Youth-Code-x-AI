  ...
  return (
    <footer className="relative bg-black">
      ...
      <div className="mx-auto max-w-4xl">
        ...
        {/* Main grid */}
        <div className="relative grid grid-cols-6 gap-6 p-6 md:p-8">
            ...
            <div className="flex gap-2">
              {SOCIAL.map(({ icon, href, label }, i) => (
                <a
                  ...
                  rel="noreferrer"
                  aria-label={label}
                  className="rounded-md p-1.5 text-white/35 transition-colors duration-150
                             border border-white/[0.08] hover:bg-white/[0.06] hover:text-white/70"
                >
                  {icon}
                </a>
              ))}
          ...
          <div className="col-span-3 w-full md:col-span-1">
            <span className="mb-2 block font-mono text-[10px] uppercase tracking-widest text-white/25">
              Product
            </span>
              ...
              {NAV_LINKS.map(({ href, title }) => {
                ...
                return isScroll ? (
                  <button
                    ...
                    className="w-max py-1 font-mono text-sm text-white/45
                               duration-150 hover:text-white/80 text-left"
                  >
                    {title}
                  </button>
                ) : (
                  <Link
                    ...
                    to={href}
                    className="w-max py-1 font-mono text-sm text-white/45
                               duration-150 hover:text-white/80"
                  >
                    {title}
                  </Link>
                );
        ...
        <div className="px-6 py-5 md:px-8">
          <p className="text-center font-mono text-[11px] font-light text-white/20">
            © {year} Engram. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
